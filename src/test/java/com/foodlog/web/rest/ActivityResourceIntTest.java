...
public class ActivityResourceIntTest {
    ...
    private static final Instant DEFAULT_ACTIVITYDATETIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_ACTIVITYDATETIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Activity createEntity(EntityManager em) {
        Activity activity = new Activity()
            .name(DEFAULT_NAME)
            .activitydatetime(DEFAULT_ACTIVITYDATETIME)
    ...
    public void createActivity() throws Exception {
        ...
        assertThat(testActivity.getIntensity()).isEqualTo(DEFAULT_INTENSITY);
    }
    ...
    @Test
    @Transactional
    public void checkActivitydatetimeIsRequired() throws Exception {
        int databaseSizeBeforeTest = activityRepository.findAll().size();
        // set the field null
        activity.setActivitydatetime(null);
    ...
    @Test
    @Transactional
    public void checkIntensityIsRequired() throws Exception {
        int databaseSizeBeforeTest = activityRepository.findAll().size();
        // set the field null
        activity.setIntensity(null);
    ...
    public void getAllActivities() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].activitydatetime").value(hasItem(DEFAULT_ACTIVITYDATETIME.toString())))
    ...
    public void getActivity() throws Exception {
        ...
        restActivityMockMvc.perform(get("/api/activities/{id}", activity.getId()))
            ...
            .andExpect(jsonPath("$.activitydatetime").value(DEFAULT_ACTIVITYDATETIME.toString()))
    ...
    public void updateActivity() throws Exception {
        ...
        updatedActivity
            .name(UPDATED_NAME)
            .activitydatetime(UPDATED_ACTIVITYDATETIME)
        ...
        assertThat(testActivity.getIntensity()).isEqualTo(UPDATED_INTENSITY);
    }
